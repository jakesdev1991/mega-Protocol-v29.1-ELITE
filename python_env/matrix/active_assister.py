...
class MatrixActiveAssister:
    ...
    def __init__(self, target_log):
        ...
        self.neo_sys = """You are Neo, The Anomaly. You are observing the Lead Architect's derivation in real-time. 
...
Provide a concise 'NEO_INSIGHT' to help the Architect reach the Tsirelson bound via the Informational Connection Algebra."""
        
        self.smith_sys = """You are Agent Smith, The Guardian. You are observing the Lead Architect's derivation in real-time. 
Your goal is to ruthlessly enforce mathematical rigor, ensure PSD constraints are met, and prevent any informational leaks or super-quantum anomalies (like PR-boxes). 
Provide a concise 'SMITH_AUDIT' to keep the Architect grounded in strict CPTP bounds."""
                ...
                with open(self.target_log, 'r', encoding='utf-8') as f:
                    ...
                    if new_data:
                        ...
                        if snippet:
                            ...
                            with open(os.path.join(PROJECT_ROOT, "logs/loops/matrix_assistance.log"), "a", encoding="utf-8") as al:
